...
As I said before, the Story regroups all relevant information concerning the incident at hand that have been identified by CloudPak for AIOps.

1. A list of Alerts that have been identified by CloudPak for AIOps to be the most probable cause
