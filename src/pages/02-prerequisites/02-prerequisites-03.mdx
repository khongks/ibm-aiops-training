...
1. Copy and paste the following code 
          ...
          - name: install
            ...
            command:
              ...
              - |
                ...
                echo "*****************************************************************************************************************************"
                echo " ✅ STARTING: Install CP4AIOPS Prerequisites"
                echo "*****************************************************************************************************************************"
                echo ""
                echo ""
                echo "------------------------------------------------------------------------------------------------------------------------------"
                ...
                ansible-playbook ./ansible/00_ibm-aiops-install.yaml -e "config_file_path=./configs/ibm-aiops-roks-aimanager-practicum-prereqs.yaml"
                echo ""
                echo ""
                echo "*****************************************************************************************************************************"
                echo " ✅ DONE"
  ...
  Or use the [ this file here](https://raw.githubusercontent.com/niklaushirt/ibm-aiops-training/main/static/assets/prerequisites.yaml) 
