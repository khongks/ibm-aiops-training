...
1. Copy and Paste the code from <a href="https://github.com/niklaushirt/ibm-aiops-deployer/blob/main/doc/training/prerequisites-step1.yaml" target="_blank" >🌏 this file</a>


3. Replace the default Password `global_password: CHANGEME` with a Password of your choice (line 51)
