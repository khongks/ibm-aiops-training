...
1. Copy and Paste the code from <a href="https://github.com/niklaushirt/ibm-aiops-deployer/blob/main/doc/training/prerequisites-step2.yaml" target="_blank" >🌏 this file</a>
