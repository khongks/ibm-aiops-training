...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-aiops/4.2.0?topic=algorithms-natural-language-log-anomaly-detection" target="_blank" >🌏 Documentation for the Task: Setting up training for log anomaly detection - natural language</a>
