...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.2.0?topic=algorithms-natural-language-log-anomaly-detection" target="_blank" >🌏 Documentation for the Task: Setting up training for log anomaly detection - natural language</a>
...
1. In the `CP4AIOPS` "Hamburger" Menu select `Operate`/`AI Model Management`
