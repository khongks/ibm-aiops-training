...
This is not part of the actual installation of CP4AIOPS and the commands are not hidden. So you just have to follow the instructions.
...
Click on `💡 Solution?` below to test it and see more details.
