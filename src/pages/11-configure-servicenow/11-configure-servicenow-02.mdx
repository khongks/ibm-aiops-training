...
Customers will typically install the AIOPS app (or plug-in) from the official <a href="https://store.servicenow.com/sn_appstore_store.do#!/store/application/632a6d81db102010253148703996197e/1.1.0" target="_blank" >ServiceNow App Store</a>. 
