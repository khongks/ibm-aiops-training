...
4. After pasting the value in the field, a *Verified* message should display.
	...
	If you get an error on versions prior to 4.0 please check that you have followed [this](https://niklaushirt.github.io/ibm-aiops-training/06-configure-aimanager/06-configure-aimanager-09/)
...
2. Click `Create New Command` to create a new slash command. 
	...
	|Short Description| Welcome to CloudPak for AIOps|
