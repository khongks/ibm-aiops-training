...
## 🚀 TASK: Integrate Instana with CP4AIOPS

<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-aiops/3.5.1?topic=connections-instana" target="_blank" >🌏 Documentation for the Task: Creating Instana connections</a>



In this section you will connect CP4AIOPS to the existing Instana instance using the following parameters:
