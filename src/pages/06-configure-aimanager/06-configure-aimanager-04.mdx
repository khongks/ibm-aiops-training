...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.1.0?topic=authentication-configuring-ldap-connections" target="_blank" >🌏 Documentation for the Task: Configuring LDAP connection</a>
...
1. In the `CP4AIOPS` "Hamburger" Menu select `Administration`
...
## 🚀 TASK: Create a User in CP4AIOPS

<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.1.0?topic=control-adding-users" target="_blank" >🌏 Documentation for the Task: Adding users</a>
...
1. Welcome back in CP4AIOPS as user Demo
