...
This will provide you with all the information and details that you need to configure CP4AIOPS in this chapter.
...
1. Run the following command to save a list of all the information to the `MY_CONFIGURATION.txt` file.
  ...
  You will need this information for the configuration of CP4AIOPS in this chapter.
