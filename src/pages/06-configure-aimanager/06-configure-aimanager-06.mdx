...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-aiops/4.2.0?topic=connections-ansible" target="_blank" >🌏 Documentation for the Task: Ansible automation provider</a>
...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-aiops/4.2.0?topic=library-create-runbook" target="_blank" >🌏 Documentation for the Task: Creating a runbook</a>
