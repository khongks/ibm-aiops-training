...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.2.0?topic=connections-ansible" target="_blank" >🌏 Documentation for the Task: Ansible automation provider</a>
...
1. In the `CP4AIOPS` "Hamburger" Menu select `Define`/`Data and tool connections`
...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.2.0?topic=library-create-runbook" target="_blank" >🌏 Documentation for the Task: Creating a runbook</a>
...
1. Select `CP4AIOPS Mitigate Robotshop Ratings Outage`
