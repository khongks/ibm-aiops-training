...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.2.0?topic=connections-kubernetes" target="_blank" >🌏 Documentation for the Task: Creating Kubernetes connections</a>
...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.2.0?topic=applications-defining-editing" target="_blank" >🌏 Documentation for the Task: Defining and editing applications</a>
...
1. In the `CP4AIOPS` "Hamburger" Menu select `Operate`/`Resource management`
