...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.0?topic=manager-starter-installation-cli" target="_blank" >🌏 Documentation for the Task: nline starter installation of CP4AIOPS</a>
