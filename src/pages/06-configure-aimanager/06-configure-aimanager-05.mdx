...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/4.1.0?topic=connections-elk" target="_blank" >🌏 Documentation for the Task: Creating ELK connections</a>
